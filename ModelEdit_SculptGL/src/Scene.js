define(function (require, exports, module) {
  ...
  var Scene = function () {
    ...
    this._instruction = null; // socket instruction
  };
  ...
  Scene.prototype = {
    ...
    startSocket: function () {
      if ("WebSocket" in window) {
        ...
        var ws = new WebSocket('ws://localhost:20000', 'echo-protocol');
        ws.onopen = function () {
        ...
        ws.onmessage = function (evt) {
          ...
          if ( instruction.operation === 'emboss' )
          {
            console.log("emboss");
            //alert('emboss');
            //console.log(instruction.embossingPointX + ' ' + instruction.embossingPointY);


            //console.log(canvas.socketGet.getOperation)
//            emboss(instruction.embossingPointX, instruction.embossingPointY);
            canvas.socketGet.setOperationDown(instruction.operation, instruction.embossingPointX, instruction.embossingPointY);
          }
          else if ( instruction.operation === 'move' )
          {
            console.log("move");
//            moveRightPointer(instruction.pointerRightX, instruction.pointerRightY);
            canvas.socketGet.setOperationMove(instruction.operation, instruction.embossingPointX, instruction.embossingPointY);
          }
