define(function (require, exports, module) {
  ...
  SculptGL.prototype = {
    addEvents: function () {
      ...
      // hand
      //canvas.addEventListener('handmove', Utils.throttle(this.onHandMove.bind(this), 16.66), false);
      //canvas.addEventListener('socket', function(event) {
      //  // 做指令编辑
      //  console.log('socket get!');
      //}, false);
      canvas.addEventListener('socketdevicemove', this.onSocketDeviceMove.bind(this), false);
      canvas.addEventListener('socketdevicedown', this.onSocketDeviceDown.bind(this), false);
    ...
    // HAND EVENTS
    ///////////////
    //onHandMove: function (event) {
    //  event.stopPropagation();
    //  event.preventDefault();
    //
    //  this._gui.callFunc('onHandMove', event);
    //  this.onFakeDeviceMove(event);
    //},
    onSocketDeviceMove: function (event) {
      this.onDeviceUp();
      console.log('socket!!!!!!');
      //event.stopPropagation();
      //event.preventDefault();
      //
      this._gui.callFunc('onSocketDeviceMove', event);
      this.onFakeDeviceMove(event);
      //this.onDeviceDown(event);
    },
    onSocketDeviceDown: function (event) {
      console.log('socket device down');
      //event.stopPropagation();
      //event.preventDefault();
      //
      this._gui.callFunc('onSocketDeviceDown', event);
      this.onFakeDeviceDown(event);
      //setTimeout(1000);
    ...
    setMousePosition: function (event) {
      ...
      this._mouseX = canvas.socketGet.getHandX();
      this._mouseY = canvas.socketGet.getHandY();
      //console.error(Scene._instruction);
      //this._mouseX = Scene._instruction.embossingPointX;
      //this._mouseY = Scene._instruction.embossingPointY;
      console.log('_mouseX: ' + this._mouseX);
      console.log('_mouseY: ' + this._mouseY);
    },
    ...
    onFakeDeviceDown: function (event) {
      if (this._focusGui)
        return;
    ...
    onFakeDeviceMove: function (event) {
      if (this._focusGui)
        return;
      this.setMousePosition(event);
      //console.error(this._mouseX + ' ' + this._mouseY);
